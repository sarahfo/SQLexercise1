...
SELECT givenname, surname, email FROM salespeople WHERE region LIKE '%Northwest%';
...
SELECT melon_type, common_name FROM melons WHERE melon_type LIKE '%watermelon%' AND price > 5;
